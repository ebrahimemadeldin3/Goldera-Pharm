        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
          <div className="relative mx-auto size-28 shrink-0 sm:mx-0 sm:size-[116px]">
            ...
            <button
              ...
              onClick={() => setDialogOpen(true)}
              aria-label="Change profile photo"
              className="profile-camera text-gp-navy-900 ring-gp-border-control hover:bg-gp-surface-subtle focus-visible:ring-gp-navy-900/15 absolute right-1 bottom-1 flex size-9 cursor-pointer items-center justify-center rounded-full bg-white shadow-[0_8px_18px_rgba(24,32,51,0.14)] ring-1 transition-colors duration-[190ms] ease-out focus-visible:ring-2 focus-visible:outline-none"
            >
