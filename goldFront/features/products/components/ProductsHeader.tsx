...
export default function ProductsHeader() {
  ...
  return (
    <div className="space-y-5">
      <header className="products-page-enter flex flex-wrap items-end justify-between gap-4">
        <div className="min-w-0">
          <p className="text-[10px] font-semibold tracking-[0.08em] text-[#C9A44C] uppercase">
            Commercial
          </p>
          <h1 className="mt-1 text-[22px] leading-tight font-semibold text-[#182033] sm:text-[26px]">
            Products
          </h1>
        </div>
      </header>

      <section className="products-hero-shell relative isolate min-h-[336px] overflow-hidden rounded-[18px] border border-[#243A5B] bg-[#101D36] shadow-[0_8px_22px_rgba(16,29,54,0.10)] sm:min-h-[360px]">
        ...
        <div className="relative z-20 flex min-h-[336px] max-w-[720px] flex-col justify-center px-5 py-8 sm:min-h-[360px] sm:px-7 lg:w-[52%] lg:px-8">
          ...
          <h2 className="products-hero-stagger products-hero-stagger-heading mt-5 text-[30px] leading-[1.16] font-semibold text-white sm:text-[38px] lg:text-[42px]">
            Pharmaceutical Excellence, Managed with Precision
          </h2>
          <p className="products-hero-stagger products-hero-stagger-copy mt-5 max-w-[650px] text-[15px] leading-7 text-[#D8E1EF] sm:text-[16px]">
            Explore our complete product portfolio, categorized and optimized
            for pharmaceutical operations. Manage pricing, inventory status, and
            compliance documentation from a single interface.
          </p>

          {isManager && (
            <div className="products-hero-stagger products-hero-stagger-actions mt-7 flex flex-wrap gap-3">
              <AddProductDialog />
            </div>
          )}
        </div>
